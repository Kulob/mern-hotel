      ...
      {loading ? (
        ...
        <div className="hotelContainer">
          ...
          <div className="hotelWrapper">
            ...
            <span className="hotelDistance">Отличное расположение – {data.distance}</span>
            <span className="hotelPriceHighlight">
              Забронируйте проживание в этом отеле стоимостью более {data.cheapestPrice} ₽ и
              получите бесплатное такси до аэропорта
            </span>
            ...
            <div className="hotelDetails">
              ...
              <div className="hotelDetailsPrice">
                ...
                >
                  <button style={{ width: '100%' }} onClick={() => makeRequest()}>
                    Платить сейчас
                  </button>
                </StripeCheckout>
              </div>
